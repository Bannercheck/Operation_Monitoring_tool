...
**Anlık bildirim:** üst çubuktaki 🔔 zil açık anomalileri 15 saniyede bir çeker; panelde "Tarayıcı bildirimi aç" deyip izin verince yeni anomaliler işletim sistemi bildirimi olarak da gelir (Watchover sekmesi arkada olsa bile). E-posta / SMS kuralları Sistem › Bildirimler sekmesinde.
