...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "landing_title": "Upload an operational dataset",
        ...
        "step1": "1 · Ingest", "step1d": "auto-detect format, map columns to roles",
        "step2": "2 · Reduce", "step2d": "mask volatile values, fingerprint, burst detection",
        "step3": "3 · Correlate", "step3d": "time window + shared entities → incidents, root cause",
        "step4": "4 · Act", "step4d": "scored rationale, evidence, actions, postmortem",
    ...
    "tr": {
        ...
        "landing_title": "Operasyonel veri setini yükleyin",
        ...
        "step1": "1 · Al", "step1d": "formatı otomatik tanı, sütunları rollere eşle",
        "step2": "2 · Azalt", "step2d": "değişken değerleri maskele, parmak izi, patlama tespiti",
        "step3": "3 · İlişkilendir", "step3d": "zaman penceresi + ortak varlık → incident, kök neden",
        "step4": "4 · Aksiyon", "step4d": "puanlı gerekçe, kanıt, aksiyon, postmortem",
