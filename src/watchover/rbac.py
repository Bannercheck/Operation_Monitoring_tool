...
PERMISSIONS: dict[str, tuple[str, str, str]] = {   # key: (group, Turkish label, English label)
    ...
    "page.sys": ("page", "Sistem sayfası", "System page"), "page.readme": ("page", "README", "README"),
    ...
    "sys.users": ("sys", "Sistem › Kullanıcılar ve roller", "System › Users and roles"), "sys.auth": ("sys", "Sistem › Giriş sağlayıcıları", "System › Sign-in providers"),
...
BUILTIN: dict[str, dict] = {
    ...
    "operator": {"label": ("Operatör", "Operator"), "desc": ("Operasyon, veri, kaynak, envanter, playbook ve ITSM işleri; sistem yönetimi yok.", "Operations, data, sources, inventory, playbook and ITSM work; no system administration."),
                 "perms": {k for k in ALL if k.startswith("page.") and k != "page.sys"} | {"act.sim", "act.connect", "act.report", "act.export", "act.sources", "act.inventory"}},
