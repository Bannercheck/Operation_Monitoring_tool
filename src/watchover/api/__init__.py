...
def create_app(services=None) -> FastAPI:
    ...
    from .routers import actions, agents, anomalies, assist, auth, datasets, grok, inventory, itsm, knowledge, live, llm, map as map_, notify, playbook, sources, system, users
    ...
    for r in (auth, datasets, live, actions, anomalies, playbook, agents, sources, inventory, knowledge, notify, users, system, map_, assist, llm, itsm, grok):
