...
|---|---|---|
| `test_pipeline.py` | CF5.1 | Format tespiti, 7 parser (SAP ailesi: 8 örnek dosya, 8 biçim), değer bazlı auto-map, açık mapping, yardımcılar, ZIP + TAR.GZ, gerçek veri şekilleri (iç içe JSON, Türkçe CSV, kv öneki, zamansız satır), profil, patlama, incident zinciri / kök neden / gerekçe, aksiyon deposu, iki set karşılaştırma |
