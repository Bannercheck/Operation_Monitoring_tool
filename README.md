...
| `assistant.py` | CF5.1 | Watchover'a sor | `build_context()` incident satırları + kanıt + dersler + kurallar, `answer()` LLM ile (kaynak zorunlu sistem istemi, son 6 mesaj) ya da `fallback_answer()` deterministik derleme |
