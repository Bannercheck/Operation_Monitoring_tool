...
import { Activity, AlertTriangle, BellRing, BookOpen, Bot, Brain, ClipboardList, Database, FileText, LogOut, Menu, MessageSquare, Network, PanelLeftClose, PanelLeftOpen, Plug, Radar, Settings2, Ticket, Users } from "lucide-react";
...
const NAV = [
  ...
  { group: "nav_group_admin", items: [
    { to: "/connections", k: "nav_conn", icon: Plug, perm: "page.conn" }, { to: "/sources", k: "nav_sources", icon: Radar, perm: "page.src" }, { to: "/llm", k: "nav_llm", icon: Bot, perm: "page.llm" }, { to: "/alerts", k: "nav_ntf", icon: BellRing, perm: "sys.notify" },
