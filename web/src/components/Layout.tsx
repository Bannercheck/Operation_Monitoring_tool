...
import { Activity, AlertTriangle, BellRing, BookOpen, Bot, Brain, ClipboardList, Database, FileText, LogOut, Menu, MessageSquare, Network, PanelLeftClose, PanelLeftOpen, Plug, Puzzle, Radar, Server, Settings2, Ticket, Users } from "lucide-react";
